...
public class MovieController {
	...
	@ResponseBody
	public String del_seat(HttpServletRequest req, Model m,int ms_no,int cno) {
		service.del_seat(req, m, ms_no, cno);
	...
	public String getMovieAllList(Model m ) {
		/*m.addAttribute("movieAll",service.getMschedule(detail));*/
